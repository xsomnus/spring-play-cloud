package com.xsomnus.playcloudstream;
...
public class PlayCloudStreamApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(PlayCloudStreamApplication.class, args);
    }
